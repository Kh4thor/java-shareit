...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> searchItemByText(String text, Long ownerId) {
        return get("/search?text=" + text, ownerId);
    }

    public ResponseEntity<Object> createComment(Long commentatorId, Long itemId, CreateCommentDto createCommentDto) {
        return post("/" + itemId + "/comment", commentatorId, createCommentDto);
    }
}